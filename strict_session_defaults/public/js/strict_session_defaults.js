(function () {
    ...
    */
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var route = frappe.router.current_route;
        ...
        frappe.strict_session_defaults.show = function() {
            ...
            frappe.call({
                ...
                callback: function(data) {
                    var fields = JSON.parse(data.message);
                    ...
                    d.set_primary_action(__('Save'), function() {
                        ...
                        var reqd_fields = frappe.strict_session_defaults._reqd_fields || [],
                        count = 0;
...
//# sourceMappingURL=strict_session_defaults.js.map
